...
description: "This post describes a set of optimisations to the BPE tokeniser training algorithm required to learn a large vocabulary on a large dataset."
---
